...
public class TestSetupHooks {
  ...
  public static void setFileAbsolutePath() {
    ...
    PluginPropertyUtils.addPluginProp("TestOutputFile", Paths.get(TestSetupHooks.class.getResource
        ("/" + PluginPropertyUtils.pluginProp("TestOutputFile")).getPath()).toString());
      PluginPropertyUtils.addPluginProp("TestOutputFileWithFilter", Paths.get(TestSetupHooks.class.getResource
        ("/" + PluginPropertyUtils.pluginProp("TestOutputFileWithFilter")).getPath()).toString());
